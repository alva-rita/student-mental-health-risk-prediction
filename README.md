...
| Model               | Stress Accuracy | Depression Accuracy |
| ------------------- | --------------- | ------------------- |
| Logistic Regression | 91.5%           | 87.3%               |
| Decision Tree       | xx              | xx                  |
| Random Forest       | xx              | xx                  |
...
Good preprocessing significantly improved performance.
Stress predictors were stronger than depression predictors.
Depression exhibited more distributed relationships across features.
...
Screenshots to be updated (heatmap, confusion matrix, pipeline, prediction table)
